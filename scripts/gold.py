# TODO (Pessoa 3): script ja esta pronto, so descomentar o codigo abaixo e
# rodar "python scripts/gold.py" para testar. Se algum nome de coluna da
# Silver ficar diferente do esperado, ajustar a lista COLUNAS_GOLD.
#
# """
